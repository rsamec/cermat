...
import M9C_2025 from './exams/M9C-2025';
import M9D_2025 from './exams/M9D-2025';
...
import MMA_2025 from './exams/MMA-2025';
...
const examTestCases: { quiz: AnswerGroup<any>, pathes: string[], config: { questions?: boolean } }[] = [
  // math
  { pathes: math8Years.concat("M5A-2025"), quiz: M5A_2025, config: { questions: true } },
  { pathes: math8Years.concat("M5B-2025"), quiz: M5B_2025, config: { questions: true } },
  ...
  { pathes: math6Years.concat("M7A-2025"), quiz: M7A_2025, config: { questions: true } },
  { pathes: math6Years.concat("M7B-2025"), quiz: M7B_2025, config: { questions: true } },
  ...
  { pathes: math4Years.concat("M9B-2025"), quiz: M9B_2025, config: { questions: true } },
  { pathes: math4Years.concat("M9C-2025"), quiz: M9C_2025, config: { questions: true } },
  { pathes: math4Years.concat("M9D-2025"), quiz: M9D_2025, config: { questions: true } },
  ...
  { pathes: math4Years.concat("M9C-2024"), quiz: M9C_2024, config: { questions: true } },
  { pathes: math4Years.concat("M9D-2024"), quiz: M9D_2024, config: { questions: true } },

  { pathes: math4Years.concat("M9A-2023"), quiz: M9A_2023, config: { questions: true } },
  { pathes: math4Years.concat("M9B-2023"), quiz: M9B_2023, config: { questions: true } },
  { pathes: math4Years.concat("M9C-2023"), quiz: M9C_2023, config: { questions: true } },
  { pathes: math4Years.concat("M9D-2023"), quiz: M9D_2023, config: { questions: true } },

  { pathes: mathDiploma.concat("MMA-2025"), quiz: MMA_2025, config: { questions: true } },
  ...
  { pathes: cz4Years.concat("C9I-2025"), quiz: C9I_2025, config: { questions: true} },
  { pathes: cz4Years.concat("C9A-2025"), quiz: C9A_2025, config: { questions: true} },
  ...
  { pathes: cz4Years.concat("C9C-2024"), quiz: C9C_2024, config: { questions: true } },
  { pathes: cz4Years.concat("C9D-2024"), quiz: C9D_2024, config: { questions: true } },
  ...
  { pathes: cz4Years.concat("C9C-2023"), quiz: C9C_2023, config: { questions: true } },
  { pathes: cz4Years.concat("C9D-2023"), quiz: C9D_2023, config: { questions: true } },
  

  { pathes: czDimploma.concat("CMA-2023"), quiz: CMA_2023, config: { questions: true } },
  { pathes: czDimploma.concat("CMB-2023"), quiz: CMB_2023, config: { questions: true } },
  { pathes: czDimploma.concat("CMA-2024"), quiz: CMA_2024, config: { questions: true } },
  { pathes: czDimploma.concat("CMB-2024"), quiz: CMB_2024, config: { questions: true } },

  // english  
  { pathes: enDiploma.concat("AJA-2023"), quiz: AJA_2023, config: { questions: true } },
  { pathes: enDiploma.concat("AJB-2023"), quiz: AJB_2023, config: { questions: true } },
  { pathes: enDiploma.concat("AJA-2024"), quiz: AJA_2024, config: { questions: true } },
  { pathes: enDiploma.concat("AJB-2024"), quiz: AJB_2024, config: { questions: true } },

  // german  
  { pathes: deDiploma.concat("DEA-2023"), quiz: DEA_2023, config: { questions: true } },
