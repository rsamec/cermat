...
const form = rootGroup({
  ...
  4: group({
    4.1: mathExpr('(64/9)b^2', { hintType: 'expression' }),
    4.2: mathExpr('(2+x)(2-x)', { hintType: 'expression' }),
    4.3: mathExpr('c+49', { hintType: 'expression' }, twoPoints),
  }),
  5: group({
    5.1: mathEquation('x=9', { hintType: 'equation' }, twoPoints),
