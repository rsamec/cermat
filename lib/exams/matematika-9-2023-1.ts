...
const form = group({
  ...
  2: group({
    2.1: { verifyBy: { kind: "equal", args: 1.2 }, points: 2, inputBy: { kind: 'number', args: { suffix: 'litru', step: 0.1 } } },
  ...
  4: group({
    4.1: { verifyBy: { kind: 'equalMathExpression', args: 'x(2x-1)' }, points: 1, inputBy: { kind: 'math', args: { hintType: 'expression' } } },
    4.2: { verifyBy: { kind: 'equalMathExpression', args: '4/9a^2-4a+9' }, points: 1, inputBy: { kind: 'math', args: { hintType: 'expression' } } },
