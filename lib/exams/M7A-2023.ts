...
const form = group({
 ...
 8: selfEvaluateImage("V rovině leží bod C a přímky a, b.jpeg",threePoints),
 9: selfEvaluateImage(" V rovině leží body K, S a přímka p procházející bodem S",threePoints),                  
 10:group({
  10.1:option('N'),
  10.2:option('A'),
  10.3:option('N'),
