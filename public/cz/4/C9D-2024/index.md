...
- [B] Hlavním účelem tohoto textu, jehož druhá část obsahuje líčení (tj. subjektivně 
...
seznámit čtenáře s jedním australským přírodním objektem.
...
- [A] Každá z těchto informací je ve výchozím textu čtenářům předkládána jako zcela jistá.
- [B] Každá z těchto informací je ve výchozím textu čtenářům předkládána jako nejistá.
- [C] Informace č. 1 je ve výchozím textu čtenářům předkládána jako jistější než informace č. 2.
- [D] Informace č. 2 je ve výchozím textu čtenářům předkládána jako jistější než informace č. 1.
# 10 Ve kterém z následujících úseků výchozího textu se vyskytuje sloveso dokonavé?
- [A] každý den prochází
- [B] patřila odpradávna lidu
- [C] proudí davy návštěvníků
- [D] ho takto nazval průzkumník
# 11 Ve které z následujících možností je uvedena dvojice slov, jež lze v kontextu 
...
- [C] neodradí – doporučí
- [D] vyjde – zajde
# 12 Vypište z __první části__ výchozího textu tři dvouslabičné předložky.
...
# 16 Najděte ve výchozím textu čtyři slova, která jsou zapsána s pravopisnou chybou, a napište je __pravopisně správně__.
