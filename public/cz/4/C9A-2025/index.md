...
# 8 Vypište z __první části__ výchozího textu tři podstatná jména, která se skloňují podle vzoru *muž*.
(Slovo *Grassmayr* neposuzujte, není správným řešením. Za chybu je považováno jak neuvedení 
hledaného slova, tak zapsání jakéhokoli slova, které neodpovídá zadání.)
# 9 Která z následujících informací je ve výchozím textu předkládána jako nejméně jistá?
- [A] informace, že odlévání zvonu je dost rizikové
- [B] informace, že zvon #9801 byl odlit v červnu 2022
- [C] informace, že odlití zvonu #9801 trvalo pouhých 6 minut
- [D] informace, že kdysi se nepovedlo některé velké zvony odlít napoprvé
# 10 Které z následujících tvrzení o zájmenu tučně vyznačeném ve výchozím textu je pravdivé?
...
# 11 Ve které z následujících možností je významový vztah mezi slovy nejpodobnější vztahu mezi slovy ZVONOVINA – ZVON?
(Slova *zvonovina* a *zvon* posuzujte ve významu, v němž jsou užita ve výchozím textu. Správná je pouze 
možnost, v níž pořadí slov odpovídá pořadí *zvonovina* – *zvon*.)
- [A] sníh – iglú
- [B] sopka – láva
- [C] poleva – čokoláda
- [D] zmrzlina – kornout
# 12 Souvětí: *****, která nejčastěji zobrazují momentky ze života obyčejných lidí, toto prestižní ocenění patří právem.
...
# 19 
## 19.1 Napište druh příslovečného určení, kterým je v TEXTU 1 větný člen *kvůli stavbě*.
## 19.2 Napište druh příslovečného určení, kterým je v TEXTU 1 větný člen *navěky*.
(Odpověď zapište slovem, nepoužívejte zkratky. Posuzované větné členy jsou v TEXTU 1 zapsány 
velkými písmeny.)
# 20 Která z následujících možností vystihuje TEXT 1?
(Úlohu řešte na základě definic uvedených v TEXTU 2.)
- [A] Text obsahuje stručnou vnější charakteristiku L. Prossera i Arthura. Jedna z těchto 
postav je v textu charakterizována pomocí charakteristiky vnitřní typu A. 
- [B] Text obsahuje stručnou vnější charakteristiku L. Prossera i Arthura. Pomocí 
charakteristiky vnitřní typu A tyto postavy charakterizovány v textu nejsou.
- [C] Text obsahuje stručnou vnější charakteristiku L. Prossera, nikoli však Arthura. Jedna 
z těchto postav je v textu charakterizována pomocí charakteristiky vnitřní typu A.
- [D] Text obsahuje stručnou vnější charakteristiku L. Prossera, nikoli však Arthura. 
Pomocí charakteristiky vnitřní typu A tyto postavy charakterizovány v textu nejsou.
# 21 Které z následujících tvrzení o vynechaném místě (*****) v TEXTU 1 je pravdivé? 
(Na vynechané místo lze doplnit pouze takový úsek, který zachová textovou návaznost.)
- [A] Na toto místo lze doplnit jak úsek *Vzápětí padla otázka: „A jestli se vám je podaří* 
*najít?“*, tak úsek *Vzápětí padla otázka, jestli se mu je podaří najít*.
- [B] Na toto místo lze doplnit jak úsek *Vzápětí padla otázka: „A jestli se vám je podaří* 
*najít?“*, tak úsek *Vzápětí padla otázka, jestli se jim je podaří najít*.
- [C] Na toto místo lze doplnit jak úsek *Vzápětí padla otázka: „A podařilo se vám je* 
*najít?“*, tak úsek *Vzápětí padla otázka, jestli se mu je podařilo najít*.
- [D] Na toto místo lze doplnit jak úsek *Vzápětí padla otázka: „A podařilo se vám je* 
*najít?“*, tak úsek *Vzápětí padla otázka, jestli se jim je podařilo najít*.
# 22 Které z následujících tvrzení o slovních spojeních podtržených v TEXTU 1 
je pravdivé?
- [A] Pouze slovní spojení *jdi do háje* je v daném kontextu citově zabarvené.
- [B] Každé z těchto slovních spojení je v daném kontextu citově zabarvené.
- [C] Pouze slovní spojení *ležel v blátě* je v daném kontextu citově zabarvené.
- [D] Žádné z těchto slovních spojení není v daném kontextu citově zabarvené.
# 23 Které z následujících tvrzení o slovech tučně vyznačených v TEXTU 1 
je pravdivé?
...
# 25 Které z následujících tvrzení __neodpovídá__ výchozímu textu?
...
## 30.4 Sloveso *jít* je v souvětí *Oznámil kamarádům, že po maturitě jde na vysokou školu* užito ve stejném významu jako v souvětí ***** 
