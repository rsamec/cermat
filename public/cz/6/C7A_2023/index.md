...
# 5
Veřejně nepřístupná informace podle § 60b odst. 3 a § 80b školského zákona
# 10 Která z následujících informací je ve výchozím textu čtenářům předkládána jako 
domněnka?
...
# 11 Která z následujících možností patří na vynechané místo (
*****
) ve výchozím 
textu?
...
- [C] S těmi, co
- [D] O těch, co
# 12 Ve výchozím textu jsou tučně vyznačena čtyři slova. Kolik z nich je přídavných 
jmen měkkých?
- [A] pouze jedno
- [B] celkem dvě
- [C] celkem tři 
- [D] čtyři
# 13 Rozhodněte o každé z následujících možností, zda je zapsána pravopisně 
správně (A), nebo ne (N).
 A N
